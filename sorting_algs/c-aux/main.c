...
int main(){
  ...
  printf("bubbleSort fatto. Tempo: %lf sec.\n", t);
  ...
  printf("insertionSort fatto. Tempo: %lf sec.\n", t1);
  ...
  printf("selectionSort fatto. Tempo: %lf sec.\n", t2);
  ...
  printf("mergeSort fatto. Tempo: %lf sec.\n", t3);
